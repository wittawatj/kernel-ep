...
%\nhnote{The last paragraph of what was previously section 4 (or a shortened version) could go here but I've commented it out.}
...
\nhnote{maybe some of the tree complexity could be discussed in section \ref{sec:EP:JIT}}.
