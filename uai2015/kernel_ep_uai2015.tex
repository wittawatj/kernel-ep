...
\centering
  ...
  \includegraphics[width=0.3\textwidth]{img/uncertainty/logistic_uncertainty_test-crop}
  }
  %
...
%   }
  ...
  (c) The uncertainty estimates on the same test sets by \citeauthor{Eslami2014}'s 
  random forests.
  }
...
\figref{fig:logistic_predvar}
% \figref{fig:breiman_uncertainty}, and \figref{fig:ert_uncertainty} 
and \figref{fig:eslami_uncertainty} show uncertainty estimates of each point in 
the two test sets by our kernel-based operator and \citeauthor{Eslami2014}'s 
random forests where we fix 
