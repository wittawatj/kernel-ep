...
\paragraph{Compound gamma factor} We next simulate the compound gamma factor, % an alternative to a gamma distribution as
...
\paragraph{Classification benchmarks} In the final experiment, we demonstrate
