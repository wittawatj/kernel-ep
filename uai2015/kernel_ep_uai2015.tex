...
\begin{itemize}
\item Andrew Gelman, Tom Minka: ``Gamma prior on precision is not good''.
Cite them.
\end{itemize}
\item Show a plot of log KL error vs. log predictive variance. Expect positive
correlation. Focus on unseen incoming messages from an unexplored
region. Make sure predictive variance is high for those.
