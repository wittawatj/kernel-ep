...
\begin{figure}[t]
	...
	\subfloat[Predicting the mean of $m_{f \rightarrow X}$]{
	\includegraphics[width=0.9\columnwidth]{img/pred_var/fm_kgg_joint_-bw-out1-crop}
	}
	%\includegraphics[width=7cm]{img/pred_var/fm_kgg_joint_-bw-out2-crop}
	
	\subfloat[Predicting $\log(\alpha)$ of $m_{f \rightarrow Z}$]{
	\includegraphics[width=0.9\columnwidth]{img/pred_var/fm_kgg_joint_-fw-out1-crop}
	}
...
\wjnote{To explain.} No points lie at the bottom right i.e., high confidence when it makes a big error.
