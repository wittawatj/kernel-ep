...
We use the default settings of Infer.NET unless stated otherwise. The regression target is always the marginal belief (numerator of eq.\ \ref{eq:msgPassing:EP}),  from which the outgoing message can be calculated straightforwardly.
% as
