...
width=8cm] at (3, 0) {set of $c$ variables connected to $f$};
...
% & \approx 
% %\mathbb{E}_{\mathsf{r}(x)} \mathbb{E}_{\mathsf{s}(y)} 
...
%again \textcolor{green!70!black}{($2^{nd}$ stage)} to obtain 
...
\centering
  ...
  \includegraphics[width=11cm]{uncertainty/logistic_uncertainty_test-crop}
  }
  %
  \subfloat[Uncertainty estimates \label{fig:logistic_uncertainty_all}]{
  \includegraphics[width=11cm]{uncertainty/logistic_uncertainty_all-crop}
  }
  %
  %\caption{   
...
\begin{figure}[ht]
  ...
  \includegraphics[width=11cm]{online/logistic_01_loss-crop}
  }
  \hspace{5mm}
  \subfloat[Inference time\label{fig:logistic_inference_time}]{
  \includegraphics[width=11cm]{online/logistic_inference_time-crop}
  }
...
% 	}
  ...
  \includegraphics[width=9cm]{online/cg_post_shape-crop}
  %\missingfigure[figwidth=0.49\columnwidth]{}
  }
  %
  \subfloat[Inferred rate \label{fig:cg_infer_rate}]{
  \includegraphics[width=9cm]{online/cg_post_rate-crop}
  %\missingfigure[figwidth=0.49\columnwidth]{}
  }
  %
...
\begin{figure}[ht]
  ...
  \subfloat[Incoming messages]{
      \includegraphics[width=0.45\columnwidth]{online/uci_in_msgs-crop}
  }

  \subfloat[Test error\label{fig:uci_01_loss}]{
  \includegraphics[width=0.41\columnwidth]{online/uci_classification-crop}
  }
  %
  \subfloat[Inference time\label{fig:uci_infer_time}]{
  \includegraphics[width=0.41\columnwidth]{online/uci_infer_time-crop}
  }
