...
set incsearch
set mouse=a
set runtimepath=~/.vim,~/.vim/bundle/Vundle.vim,~/.vim/bundle/YouCompleteMe,~/.vim/bundle/command-t,~/.vim/bundle/ctrlp,~/.vim/bundle/delimitMate,~/.vim/bundle/fugitive,~/.vim/bundle/matchit,~/.vim/bundle/matlab,~/.vim/bundle/molokai,~/.vim/bundle/nerdcommenter,~/.vim/bundle/nerdtree,~/.vim/bundle/solarized,~/.vim/bundle/syntastic,~/.vim/bundle/tagbar,~/.vim/bundle/vim-easymotion,~/local/share/vim/vimfiles,~/local/share/vim/vim74,~/local/share/vim/vimfiles/after,~/.vim/after,~/.vim/bundle/Vundle.vim/after
set shiftwidth=4
set showbreak=↪
set smartcase
...
silent only
cd ~/SHARE/gatsby/research/code
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +61 main/tool/dist/DistArray.m
badd +37 main/tool/features/RandFourierGaussMap.m
badd +51 main/tool/features/RandFourierGaussMVMap.m
badd +17 main/cond/cond_fm_finiteout.m
badd +1 main/tool/dist/Distribution.m
badd +1 main/cond/CondFMFiniteOut.m
badd +73 main/cond/CondCholFiniteOut.m
badd +2 main/tool/kernel/KGaussian.m
badd +83 main/tool/kernel/KMVGauss1.m
badd +4 main/tool/data/TensorInstances.m
badd +1 /opt/matlab-R2012b/toolbox/matlab/elmat/ind2sub.m
badd +48 main/problem/exp/ExpMapper.m
badd +51 main/problem/exp/ExpPrimalMapper.m
badd +23 main/tool/dist/DistMapper2Factory.m
badd +1 main/tool/dist/DistMapper2PrimalFactory.m
badd +1 main/tool/dist/GenericMVMapper2In.m
badd +12 main/tool/data/InstancesMapper.m
badd +38 main/tool/data/MV1Instances.m
badd +7 main/tool/dist/DistMapper2.m
badd +27 main/tool/data/MsgBundle2.m
badd +41 main/tool/dist/DistNormalBuilder.m
badd +25 main/tool/dist/GenericMapper2In.m
badd +36 main/tool/dist/Gauss1TensorMapper2In.m
badd +3 main/problem/sigmoid/SigmoidFactor.m
badd +21 helper/dealstruct.m
badd +1 main/problem/distMapper2_tester.m
badd +13 main/tool/kernel/Kernel.m
badd +15 main/DistMapper2.m
badd +36 main/tool/dist/DistBuilder.m
badd +36 main/tool/dist/ParamsTensorMapper2In.m
badd +18 main/tool/features/FeatureMap.m
badd +1 main/tool/dist/DistBeta.m
badd +47 main/tool/dist/DistBetaBuilder.m
badd +14 main/tool/matrix/DynamicMatrix.m
badd +24 main/tool/matrix/DefaultDynamicMatrix.m
argglobal
silent! argdel *
argadd main/tool/matrix/DefaultDynamicMatrix.m
set stal=2
edit main/tool/features/RandFourierGaussMVMap.m
...
setlocal tabstop=4
setlocal tags=~/SHARE/gatsby/research/.git/matlab.tags,~/SHARE/gatsby/research/.git/tags,./tags,./TAGS,tags,TAGS
...
wincmd w
argglobal
edit main/tool/features/RandFourierGaussMap.m
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
exe 'vert 1resize ' . ((&columns * 102 + 102) / 205)
exe 'vert 2resize ' . ((&columns * 102 + 102) / 205)
tabedit main/tool/matrix/DefaultDynamicMatrix.m
set splitbelow splitright
wincmd _ | wincmd |
vsplit
wincmd _ | wincmd |
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 29 + 102) / 205)
...
setlocal tabstop=4
setlocal tags=~/SHARE/gatsby/research/.git/tags,./tags,./TAGS,tags,TAGS
setlocal textwidth=0
setlocal thesaurus=
setlocal noundofile
setlocal undolevels=-123456
...
wincmd w
argglobal
edit main/tool/matrix/DynamicMatrix.m
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
exe 'vert 2resize ' . ((&columns * 87 + 102) / 205)
exe 'vert 3resize ' . ((&columns * 87 + 102) / 205)
tabedit main/cond/CondFMFiniteOut.m
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 30 - ((17 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
...
wincmd w
argglobal
edit main/cond/cond_fm_finiteout.m
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
exe 'vert 1resize ' . ((&columns * 102 + 102) / 205)
exe 'vert 2resize ' . ((&columns * 102 + 102) / 205)
tabedit main/problem/distMapper2_tester.m
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
wincmd w
argglobal
edit main/tool/dist/GenericMapper2In.m
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
exe 'vert 1resize ' . ((&columns * 102 + 102) / 205)
exe 'vert 2resize ' . ((&columns * 102 + 102) / 205)
tabedit main/tool/dist/DistMapper2PrimalFactory.m
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((26 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
wincmd w
argglobal
edit main/problem/exp/ExpPrimalMapper.m
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <S-Tab> <Plug>delimitMateS-Tab
imap <buffer> <S-BS> <Plug>delimitMateS-BS
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((28 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
