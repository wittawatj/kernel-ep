function [ X, T, Xout, Tout ] = gentrain_egauss2(X, T, op)
%GENTRAIN_EGAUSS1 Generate training data for learning a conditional mean
...
iw_samples = myProcessOptions(op, 'iw_samples', 100);
