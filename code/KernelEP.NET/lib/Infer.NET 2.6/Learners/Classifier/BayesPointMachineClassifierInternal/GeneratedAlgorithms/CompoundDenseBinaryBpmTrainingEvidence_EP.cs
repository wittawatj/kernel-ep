...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	public partial class CompoundDenseBinaryBpmTrainingEvidence_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>The number of iterations last computed by Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6. Set this to zero to force re-execution of Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6</summary>
		public int Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6_iterationsDone;
		/// <summary>True if Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6 has performed initialisation. Set this to false to force re-execution of Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6</summary>
		public bool Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6_isInitialised;
		/// <summary>The number of iterations last computed by Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7. Set this to zero to force re-execution of Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7</summary>
		public int Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7_iterationsDone;
		/// <summary>True if Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7 has performed initialisation. Set this to false to force re-execution of Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7</summary>
		public bool Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7_isInitialised;
		...
		/// <summary>The number of iterations last computed by Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14. Set this to zero to force re-execution of Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14</summary>
		public int Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14_iterationsDone;
		/// <summary>True if Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14 has performed initialisation. Set this to false to force re-execution of Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14</summary>
		public bool Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14_isInitialised;
		/// <summary>The number of iterations last computed by Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15. Set this to zero to force re-execution of Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15</summary>
		public int Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_iterationsDone;
		/// <summary>True if Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15 has performed initialisation. Set this to false to force re-execution of Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15</summary>
		public bool Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_isInitialised;
		/// <summary>The number of iterations last computed by Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16. Set this to zero to force re-execution of Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16</summary>
		public int Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16_iterationsDone;
		public Gamma _hoist;
		...
		public DistributionStructArray<Bernoulli,bool>[] ModelSelector_selector_cases_0_rep2_uses_B;
		...
		public int InstanceCount
		{
			...
			set {
				if (this.instanceCount!=value) {
					...
					this.Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6_isInitialised = false;
					this.Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14_isInitialised = false;
					this.Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7_isInitialised = false;
					...
					this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_iterationsDone = 0;
					this.Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16_iterationsDone = 0;
				}
			}
		}
		...
		public int FeatureCount
		{
			...
			set {
				if (this.featureCount!=value) {
					...
					this.Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14_iterationsDone = 0;
					this.Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7_iterationsDone = 0;
		...
		{
			if (numberOfIterations!=this.Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16_iterationsDone) {
				this.Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14_isInitialised = false;
				this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_isInitialised = false;
				this.Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16_iterationsDone = 0;
			}
			...
			this.Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6(initialise);
			this.Changed_FeatureCount();
			this.Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14(initialise);
			this.Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7(initialise);
			...
			this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15(initialise);
			this.Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16(numberOfIterations);
		...
		private void Constant()
		{
			...
			this.Changed_FeatureCount_iterationsDone = 0;
			this.Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6_iterationsDone = 0;
			this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR13_iterationsDone = 0;
			this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_iterationsDone = 0;
			this.Changed_InstanceCount_iterationsDone = 0;
			this.Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16_iterationsDone = 0;
		...
		private void Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6(bool initialise)
		{
			if ((this.Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6_iterationsDone==1)&&((!initialise)||this.Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6_isInitialised)) {
				return ;
			}
			// Message to 'CommonWeightPrecision_rep' from Replicate factor
			...
			this.Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6_iterationsDone = 1;
			this.Init_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionRate6_isInitialised = true;
			this.Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7_iterationsDone = 0;
			this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR13_iterationsDone = 0;
		}
		...
		private void Changed_FeatureCount()
		{
			...
			// Create array for 'ModelSelector_selector_cases_0_rep2_uses' Backwards messages.
			this.ModelSelector_selector_cases_0_rep2_uses_B = new DistributionStructArray<Bernoulli,bool>[this.featureCount];
			for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
				// Create array for 'ModelSelector_selector_cases_0_rep2_uses' Backwards messages.
				this.ModelSelector_selector_cases_0_rep2_uses_B[FeatureRange] = new DistributionStructArray<Bernoulli,bool>(3);
				for(int _ind = 0; _ind<3; _ind++) {
					this.ModelSelector_selector_cases_0_rep2_uses_B[FeatureRange][_ind] = Bernoulli.Uniform();
				}
			}
			// Create array for 'ModelSelector_selector_cases_0_rep2' Backwards messages.
			...
			for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
				// Create array for 'ModelSelector_selector_cases_0_rep10_uses' Backwards messages.
				this.ModelSelector_selector_cases_0_rep10_uses_B[FeatureRange] = new DistributionStructArray<Bernoulli,bool>(2);
				for(int _ind = 0; _ind<2; _ind++) {
		...
		/// <summary>Computations that depend on the observed value of FeatureCount and must reset on changes to InstanceCount and numberOfIterations and FeatureValues and Labels and WeightPrecisionRateConstraints and WeightConstraints</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14(bool initialise)
		{
			if ((this.Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14_iterationsDone==1)&&((!initialise)||this.Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14_isInitialised)) {
				return ;
			}
			for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
				// Message to 'WeightPrecisionRates_rep' from Replicate factor
			...
			this.Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14_iterationsDone = 1;
			this.Changed_FeatureCount_Init_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateC14_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_iterationsDone = 0;
			this.Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16_iterationsDone = 0;
		}
		...
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7(bool initialise)
		{
			if ((this.Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7_iterationsDone==1)&&((!initialise)||this.Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7_isInitialised)) {
				return ;
			}
			for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
				for(int _ind = 0; _ind<2; _ind++) {
				...
				// Message to 'ModelSelector_selector_cases_0_rep2_uses' from GammaFromShapeAndRate factor
			...
			this.Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7_iterationsDone = 1;
			this.Changed_FeatureCount_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_Labels_WeightPreci7_isInitialised = true;
			this.Changed_FeatureCount_WeightConstraints_Init_numberOfIterationsDecreased_InstanceCount_FeatureValues_8_iterationsDone = 0;
			this.Changed_FeatureCount_WeightPrecisionRateConstraints_InstanceCount_FeatureValues_Init_numberOfIterati11_iterationsDone = 0;
			this.Changed_FeatureCount_WeightConstraints_WeightPrecisionRateConstraints_InstanceCount_FeatureValues_In12_iterationsDone = 0;
			this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR13_iterationsDone = 0;
		...
		private void Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR13(int numberOfIterations)
		{
			...
			for(int iteration = this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR13_iterationsDone; iteration<numberOfIterations; iteration++) {
				...
				for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
					...
					// Message to 'WeightPrecisions' from Gaussian factor
					this.WeightPrecisions_B[FeatureRange] = GaussianOp.PrecisionAverageConditional(this.Weights_uses_B_FeatureRange__toDef[FeatureRange], Gaussian.PointMass(0.0), this.WeightPrecisions_F[FeatureRange]);
					// Message to 'ModelSelector_selector_cases_0_rep3' from Ratio factor
			...
			for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
				...
				// Message to 'ModelSelector_selector_cases_0_rep2_uses' from Replicate factor
				...
				// Message to 'ModelSelector_selector_cases_0_rep2' from Replicate factor
			...
			for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
				// Message to 'ModelSelector_selector_cases_0_rep4_uses' from Gaussian factor
				this.ModelSelector_selector_cases_0_rep4_uses_B[FeatureRange][0] = Bernoulli.FromLogOdds(GaussianOp.LogEvidenceRatio(this.Weights_uses_B_FeatureRange__toDef[FeatureRange], 0.0, this.WeightPrecisions_F[FeatureRange], this.Weights_F[FeatureRange], this.WeightPrecisions_B[FeatureRange]));
				// Message to 'Weights_uses' from Replicate factor
				this.Weights_uses_F[FeatureRange][0] = ReplicateOp_Divide.UsesAverageConditional<Gaussian>(this.weightConstraints[FeatureRange], this.Weights_uses_F_FeatureRange__marginal[FeatureRange], 0, this.Weights_uses_F[FeatureRange][0]);
			...
			for(int InstanceRange = 0; InstanceRange<this.instanceCount; InstanceRange++) {
				// Message to 'ModelSelector_selector_cases_0_rep15' from IsPositive factor
		...
		/// <summary>Computations that depend on the observed value of numberOfIterationsDecreased and FeatureCount and InstanceCount and FeatureValues and Labels and WeightPrecisionRateConstraints and WeightConstraints and must reset on changes to numberOfIterations</summary>
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15(bool initialise)
		{
			if ((this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_iterationsDone==1)&&((!initialise)||this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_isInitialised)) {
				return ;
			}
			for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
				// Message to 'WeightPrecisionRates_uses' from Replicate factor
			...
			this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_iterationsDone = 1;
			this.Changed_numberOfIterationsDecreased_FeatureCount_InstanceCount_FeatureValues_Labels_WeightPrecisionR15_isInitialised = true;
			this.Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16_iterationsDone = 0;
		}

		/// <summary>Computations that depend on the observed value of FeatureCount and InstanceCount and numberOfIterations and FeatureValues and Labels and WeightPrecisionRateConstraints and WeightConstraints</summary>
		/// <param name="numberOfIterations">The number of times to iterate each loop</param>
		private void Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16(int numberOfIterations)
		{
			if (this.Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16_iterationsDone==numberOfIterations) {
				return ;
			}
			...
			for(int InstanceRange = 0; InstanceRange<this.instanceCount; InstanceRange++) {
				for(int FeatureRange = 0; FeatureRange<this.featureCount; FeatureRange++) {
					// Message to 'ModelSelector_selector_cases_0_rep6_rep' from Gaussian factor
			...
			this.Changed_FeatureCount_InstanceCount_numberOfIterations_FeatureValues_Labels_WeightPrecisionRateConstr16_iterationsDone = numberOfIterations;
		}
