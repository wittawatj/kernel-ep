...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	public partial class GaussianSparseBinaryBpmTrainingEvidence_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>The number of iterations last computed by Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2. Set this to zero to force re-execution of Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2</summary>
		public int Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2_iterationsDone;
		/// <summary>True if Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2 has performed initialisation. Set this to false to force re-execution of Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2</summary>
		public bool Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2_isInitialised;
		...
		public int InstanceCount
		{
			...
			set {
				if (this.instanceCount!=value) {
					...
					this.Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2_isInitialised = false;
		...
		public DistributionStructArray<Gaussian,double> WeightPriors
		{
			...
			set {
				...
				this.Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2_iterationsDone = 0;
				this.Changed_numberOfIterationsDecreased_WeightPriors_FeatureIndexes_InstanceCount_InstanceFeatureCounts_7_iterationsDone = 0;
			}
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2(initialise);
		...
		private void Constant()
		{
			...
			this.ModelSelector_selector_cases_0_uses_B = new Bernoulli[19];
			for(int _ind = 0; _ind<19; _ind++) {
		...
		/// <param name="initialise">If true, reset messages that initialise loops</param>
		private void Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2(bool initialise)
		{
			if ((this.Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2_iterationsDone==1)&&((!initialise)||this.Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2_isInitialised)) {
				return ;
			}
			...
			this.Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2_iterationsDone = 1;
			this.Changed_WeightConstraints_WeightPriors_Init_numberOfIterationsDecreased_FeatureIndexes_InstanceCount2_isInitialised = true;
			this.Changed_numberOfIterationsDecreased_WeightPriors_FeatureIndexes_InstanceCount_InstanceFeatureCounts_7_iterationsDone = 0;
		}
		...
		private void Changed_numberOfIterationsDecreased_WeightPriors_FeatureIndexes_InstanceCount_InstanceFeatureCounts_7(int numberOfIterations)
		{
			...
			this.ModelSelector_selector_cases_0_uses_B[10] = Bernoulli.FromLogOdds(JaggedSubarrayOp<double>.LogEvidenceRatio<Gaussian,DistributionRefArray<DistributionStructArray<Gaussian,double>,double[]>,DistributionStructArray<Gaussian,double>>(this.IndexedWeights_B, this.Weights_uses_F[1], this.featureIndexes, this.Weights_FeatureIndexes_F));
			for(int InstanceRange = 0; InstanceRange<this.instanceCount; InstanceRange++) {
				// Message to 'ModelSelector_selector_cases_0_rep9' from IsPositive factor
			...
			// Message to 'ModelSelector_selector_cases_0_uses' from Replicate factor
			this.ModelSelector_selector_cases_0_uses_B[18] = ReplicateOp_NoDivide.DefAverageConditional<Bernoulli>(this.ModelSelector_selector_cases_0_rep9_B, this.ModelSelector_selector_cases_0_uses_B[18]);
