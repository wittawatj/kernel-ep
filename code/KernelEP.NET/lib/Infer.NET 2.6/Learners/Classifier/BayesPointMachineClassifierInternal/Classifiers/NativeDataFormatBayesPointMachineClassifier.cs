...
namespace MicrosoftResearch.Infer.Learners.BayesPointMachineClassifierInternal
{
        ...
        where TPredictionSettings : IBayesPointMachineClassifierPredictionSettings<TLabel>
    {
        ...
        /// <summary>
        /// Gets the generated inference algorithms for training and prediction.
        /// </summary>
        protected IInferenceAlgorithms<TLabel, TLabelDistribution> InferenceAlgorithms { get; private set; }
